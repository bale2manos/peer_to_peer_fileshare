...
instructions = [
        ["REGISTER usuario1", "CONNECT usuario1", "PUBLISH title1 description1", "PUBLISH title2 description2", "QUIT"],
        ["REGISTER usuario2", "CONNECT usuario2", "PUBLISH title2 description2", "GET_FILE usuario1 title1 title1copia", "QUIT"]
